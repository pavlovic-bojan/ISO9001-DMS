<%@ Page Title="Upravljanje Kvalitetom | Greška" Language="C#" MasterPageFile="~/UpravljanjeKvalitetom.master" AutoEventWireup="true" CodeFile="greska.aspx.cs" Inherits="greska" %>
    ...
    contentplaceholderid="ContentPlaceHolder1">
      ...
      <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            GridLines="None">
                            ...
                            <Fields>
                                <asp:BoundField DataField="Greska" HeaderText="Greska" ShowHeader="False" 
