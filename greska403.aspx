<%@ Page Title="Upravljanje Kvalitetom | Greška 403" Language="C#" MasterPageFile="~/UpravljanjeKvalitetom.master" AutoEventWireup="true" CodeFile="greska403.aspx.cs" Inherits="greska403" %>
    ...
    contentplaceholderid="ContentPlaceHolder1">
      ...
      <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            GridLines="None">
                            ...
                            <Fields>
                                <asp:BoundField DataField="Greska403" HeaderText="Greska403" ShowHeader="False" 
